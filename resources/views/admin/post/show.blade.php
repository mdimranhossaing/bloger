                ...
                <div class="card">
                    <div class="card-header">
                        <div class="user-block">
                            <img class="img-circle" src="{{asset('upload/' . $post->user->photo)}}" alt="User Image">
                    ...
                    <div class="card-body">
                        <img class="img-fluid w-50 card-img-top pad" src="{{ asset('upload/' . $post->thumbnail) }}" alt="Photo">
