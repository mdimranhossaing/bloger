            ...
            <div class="col-md-4">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.tag.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                                ...
                                @if (count($tags) > 0)
                                    @foreach ($tags as $key => $tag)
                                        <tr>
                                            ...
                                            <td>{{ $tag->name }}</td>
                                            <td>{{ $tag->slug }}</td>
                                            <td>{{ date('s:i:h - d M Y', strtotime($tag->created_at)) }}</td>
                                            <td>{{ date('s:i:h - d M Y', strtotime($tag->updated_at)) }}</td>
                                            <td width="50">
                                                <a class="badge-btn badge-success mr-2" href="{{route('admin.tag.edit',$tag->id)}}"><i
                                                        class="fas fa-edit"></i></a>
                                                <a class="badge-btn badge-danger" href="javascript:deletePost('{{route('admin.tag.delete', $tag->id)}}')"><i
